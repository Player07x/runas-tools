...
import { calculateEquippedDefense, calculateItemRealWeight, formatWeight, inventoryTypeLabel, inventoryUsageLabel, itemRarity } from "@/lib/inventoryCalculations"
...
export function CharacterReadonlySheet({ character }: { character: Character }) {
  ...
  const defense = calculateEquippedDefense(character.inventory)
