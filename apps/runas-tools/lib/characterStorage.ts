import type { AbilityCostMode, AbilityCostType, Character, CharacterAbility, CharacterBond, CharacterInventoryItem, CharacterNote, CharacterSaveFile, CharacterSkill, CharacterSpell, InventoryItemType, InventoryUsage, SecondaryAttributeKey, SpellMagicType, SpellRangeType } from "@runas/core/types/character"
import { CHARACTER_VERSION } from "@runas/core/types/character"
import { CORE_SKILL_IDS, createCoreSkills } from "@runas/core/data/skills"
import { calculateLoadBase, deriveCharacterInfo, modifierToNumber } from "@runas/core/lib/characterCalculations"
import { calculateAttributeTest, calculateSkillModifier, normalizeSkillName } from "@runas/core/lib/skillCalculations"
import { sumAbilityModifiers } from "@runas/core/lib/abilityModifiers"
import { calculateEquippedArmorDefense, calculateInventoryLoad } from "@runas/core/lib/inventoryCalculations"
import { createEmptyMasteryImprovements } from "@runas/core/lib/masteryImprovements"
